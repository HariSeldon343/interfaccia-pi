# Interfaccia pi 2.5.4 — sorgente completo

Questa cartella contiene il pacchetto sorgente completo necessario per modificare
l'interfaccia, il bridge e l'installer desktop di Interfaccia pi 2.5.4.
...
src-tauri\target-final-2.5.4\release\bundle\msi\Interfaccia pi_2.5.4_x64_en-US.msi
```
